    ...
    <div className="min-h-screen w-full bg-[#181818] flex items-center justify-center p-4">
      ...
      >
        ...
        <div className="bg-gradient-to-r from-blue-500 to-purple-600 p-6 text-white text-center">
          ...
          <p className="text-blue-100 text-sm mt-1">Ready to download</p>
        </div>
        ...
        <div className="p-6">
          <div className="flex items-center space-x-4 p-4 bg-gray-50 rounded-xl mb-6">
            ...
            <div className="flex-1 min-w-0">
              <h3 className="font-medium text-gray-900 truncate" title={fileData?.filename}>
                {fileData?.filename}
              </h3>
              <p className="text-sm text-gray-500">
                Shared {fileData?.created_at ? new Date(parseFloat(fileData.created_at) * 1000).toLocaleDateString() : 'recently'}
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 pt-4 border-t border-gray-100 text-center">
            <p className="text-xs text-gray-500">
              Powered by <span className="font-medium">FileFlow</span>
            </p>
          </div>
        </div>
      </motion.div>
